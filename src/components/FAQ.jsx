...
const faqs = [
	...
	},
	{
		...
		answer:
			"Oui c’est possible, une formule accès libre avec plusieurs formules est proposée.",
	},
	{
	...
	return (
		<div className="bg-darkorange px-10 lg:px-20 flex flex-col gap-20 mt-20 py-10 ">
			<h2 className=" relative flex flex-col text-lg md:text-2xl font-tanker">
				<span className="text-3xl text-white z-10">FAQ</span>
				<div className="w-[2rem] h-3  bg-black -mt-3 -z-1" />
			</h2>
			<div className="space-y-6">
				{faqs.map((faq, index) => (
					<div key={index} className="border-b border-white pb-4">
						<h3
							className="text-white font-semibold mb-2 cursor-pointer flex items-center justify-between"
