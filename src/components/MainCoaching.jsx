	...
	return (
		<>
			<div className="relative">
					...
					<div className="basis-1/2">
						...
						<div className="space-y-4">
							...
							<p>
								...
								cardiovasculaire (tabagisme, diabète, cholestérol, sédentarité,
								obésité, etc.)
							</p>
							<p>
							...
							<p>- Réduire les blessures et améliorer la qualité de sommeil</p>
						</div>
					</div>
				...
				<div className="absolute lg:pb-24 -inset-10 lg:-inset-20 flex flex-col items-center justify-center z-0">
					<Image
						src={vector}
						width={"auto"}
						height={"auto"}
				...
				{/* Deuxième section */}
				<div className="flex flex-col lg:flex-row relative z-10 pt-32 ">
