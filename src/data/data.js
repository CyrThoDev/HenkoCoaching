		...
		detailsList: [
			{
				title: "Sportifs",
				description:
					"Pour accélérer la récupération après des entraînements intenses ou des compétitions.",
			},
			{
				title: "Santé et bien-être ",
				description:
					"Pour améliorer la circulation et soulager les jambes lourdes ou gonflées.",
			},
			{
				title: "Post-chirurgie ou après une blessure",
				description:
					"Pour favoriser la réduction des œdèmes et améliorer la mobilité.",
			},
		],
		prix1: "20 min : 30€ ",
		prix2: "",
		image: "/images/massage4.jpg",
		calendlyUrl: "https://calendly.com/henkocoaching/pressotherapie",
		button: "RESERVER",
	},
	{
		id: 5,
